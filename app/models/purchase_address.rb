class PurchaseAddress
  ...
  attr_accessor :post_code, :area_id, :municipalities, :address, :building, :telephone_num, :purchase, :user_id, :item_id
  ...
  def save
    ...
    Address.create(post_code: post_code, area_id: area_id, municipalities: municipalities, address: address,
                            building: building, telephone_num: telephone_num, purchase: purchase)
  end
end